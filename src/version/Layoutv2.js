...
const Layoutv2 = ({ colors }) => (
  <IpadArtboard name="layout 2" backgroundColor={ds.colors['Night']}>
    <View
      name="header"
      style={{
        width: '100%',
          ...
          <Svg.G id="Icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <Svg.G id="Artboard" transform="translate(-141.000000, -104.000000)">
              <Svg.G id="Group" transform="translate(141.000000, 104.000000)">
                ...
                <Svg.Path d="M18.75,12 L18.75,18.59375 C18.38125,18.38125 17.95625,18.25 17.5,18.25 C16.11875,18.25 15,19.36875 15,20.75 C15,22.13125 16.11875,23.25 17.5,23.25 C18.88125,23.25 20,22.13125 20,20.75 L20,14.5 L22.5,14.5 L22.5,12 L18.75,12 Z" id="Path" fill={ds.colors['Peach Dark']} fill-rule="nonzero"></Svg.Path>
              </Svg.G>
            </Svg.G>
          </Svg.G>
        </Svg>
